...
const registerDev = async (req , res)=>{
    try {
        const {empId , empName , empEmail , empPassword ,empPhn , empServiceId } = req.body;
        console.log(empId , empName , empEmail , empPassword ,empPhn , empServiceId )
        if(!empId){
            return res.json({
        ...
        const User = await user.create({
            empId , empName , empEmail , empPassword:hashedpassword ,empPhn , empServiceId
        }) 
